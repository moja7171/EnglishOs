<x-layouts.app>
    ...
    <div class="mx-auto max-w-2xl space-y-6 p-6">
        <header class="border-b border-line pb-4 dark:border-line-dark">
            ...
            <h1 class="mt-2 font-display text-2xl font-extrabold text-ink dark:text-ink-dark">The 120-day program</h1>
            <p class="mt-1 text-sm text-ink-soft dark:text-ink-soft-dark">24 missions, 5 days each. About 40 minutes a day. That's the whole plan.</p>
        </header>
        ...
        <section class="space-y-3">
            <h2 class="font-display text-lg font-bold text-ink dark:text-ink-dark">One mission = five days</h2>
            <ol class="space-y-2">
                @foreach ([
                    ...
                    ['Day 4', 'Challenge', 'Active Recall, Partner Speaking, Error Log, Final Challenge, Mission Result', '~45 min'],
                    ['Day 5', 'Consolidation', 'Daily Review · 10-15 min speaking with Pi about the mission · a glance at your Error Log', '~25 min'],
        ...
        <section class="space-y-2">
            <h2 class="font-display text-lg font-bold text-ink dark:text-ink-dark">Why a day with Pi?</h2>
            <p class="text-sm text-ink-soft dark:text-ink-soft-dark">Everything inside a mission is built around <em>producing</em> English, but the app's own AI conversations are short and structured. Real fluency needs longer, messier talk — so on day 5 you take the mission's topic, grammar point and Final Challenge questions to <a href="https://pi.ai" target="_blank" rel="noopener" class="underline">Pi</a> (free, speaks and listens) and just talk for 10-15 minutes. The Missions page gives you a ready-made prompt to paste. Afterwards you log one sentence you actually said — that's your Evidence for the day, and it keeps your streak.</p>
        </section>

        <section class="space-y-2">
            <h2 class="font-display text-lg font-bold text-ink dark:text-ink-dark">"On track" is about progress, not the calendar</h2>
            <p class="text-sm text-ink-soft dark:text-ink-soft-dark">Nothing here is locked to a date. Your <strong>program day</strong> is where you actually are in the 120 (mission days done + today). Your <strong>calendar day</strong> is how many days have passed since you started. If the second gets ahead of the first, the Missions page says "N days behind" — a nudge to catch up, never a penalty. One missed day never breaks your streak either.</p>
        </section>
        ...
        <section class="space-y-2">
            ...
            <ul class="list-disc space-y-1 pl-5 text-sm text-ink-soft dark:text-ink-soft-dark">
                ...
                <li><strong class="text-ink dark:text-ink-dark">Speak out loud, always.</strong> Every recording step, every Pi session — your mouth has to do it, not your eyes.</li>
